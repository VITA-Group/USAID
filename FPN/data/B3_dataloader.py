...
class MultiDataSet(data.Dataset):
    ...
    def __init__(self, datadir = '../../VOCdevkit/VOC2012', cropSize=50, inSize=500, testFlag=False, preload=True):
        ...
        self.mean = np.array([0.48109378172, 0.4575245789, 0.4078705409])
        if self.testFlag:
            split = 'val'
        else:
            split = 'train'
